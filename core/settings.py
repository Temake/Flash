...
SECRET_KEY = 'django-insecure-rbn21w4o58bde0zp&jhkh(mf!xgy8!kvecp6)f26+^_sdcxpr('
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API for user authentication including registration, login, password reset',
    'VERSION': '1.0.0',
